<div id="site-top-bar">
  ...
  ?>
            ...
            <div class="site-top-message"><?php if (isset($mr_tailor_theme_options['top_bar_text'])) {
  _e($mr_tailor_theme_options['top_bar_text'], 'mr_tailor');
}
?></div>
            ...
            <div class="site-social-icons-wrapper">
                <div class="site-social-icons">
                    <ul class="//animated //flipY">
                        <li class="topbar-phone">(212) 863 - 9391</li>
