                    ...
                    <footer id="site-footer" role="contentinfo">
                        ...
                        <div class="row-fluid">
                            ...
                            <?php if (is_active_sidebar('footer-widget-area')): ?>
                               ...
                               <div class="site-footer-widget-area" style="<?php if (isset($mr_tailor_theme_options['expandable_footer']) && ($mr_tailor_theme_options['expandable_footer'] == 0)) {
...
?>">
                           ...
                           <div class="site-footer-widgets">
                                   ...
                                   <?php if (is_active_sidebar('footer-1')): ?>
                                    ...
                                    <div class="large-6 columns last-column">
                           ...
                           <div class="site-footer-copyright-area">
                               ...
                               <div class="row">
                                   ...
                                   <div class="medium-12 columns">
                                       ...
                                       aa    <?php if ((isset($mr_tailor_theme_options['footer_copyright_text'])) && (trim($mr_tailor_theme_options['footer_copyright_text']) != "")) {?>
                                       ...
                                       <div class="copyright_img">
                                           ...
                                           <img src="<?php echo get_site_url(); ?>/wp-content/uploads/2017/09/Sin-título-1.png">
  ...
  if (count($additional_languages) > 1) {
    ...
    foreach ($additional_languages as $additional_language) {
      ...
      if (!$additional_language['active']) {
        ...
        $langs[] = '<option value="' . $additional_language['url'] . '">' . $additional_language['native_name'] . '</option>';
...
<?php if (is_active_sidebar('popup-top')): ?>

    <div id="popup-top" class="zoom-anim-dialog popup-with-zoom-anim mfp-hide small-dialog">

        <?php dynamic_sidebar('popup-top');?>

        <button title="Close (Esc)" type="button" class="mfp-close popup-modal-dismiss">

            <img src="<?php echo get_stylesheet_directory_uri() . '/images/close-icon-popup.png'; ?>">
...
/*
  if (has_term('create-your-own', 'product_cat')) :
    if(get_field('image_option')) :
      //echo get_field('image_option');
      $arrayFinal = array();
      $res = explode('<br />', get_field('image_option'));
      foreach ($res as $resitem) {
        $resAux = explode(', ', $resitem);
        $arrayFinal[] = $resAux;
      }
      $arrayFinal = json_encode($arrayFinal);
      ...
      ?>
        <script type="text/javascript">
          ...
          jQuery(document).ready(function($) {
            //$('');
            console.log(<?php echo $arrayFinal; ?>);
          });
