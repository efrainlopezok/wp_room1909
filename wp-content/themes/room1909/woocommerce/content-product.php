...
remove_action( 'woocommerce_after_shop_loop_item_title_loop_rating', 'woocommerce_template_loop_rating', 5 );
...
<li class="dasdfasd <?php if ( (isset($mr_tailor_theme_options['catalog_mode'])) && ($mr_tailor_theme_options['catalog_mode'] == 1) ) : ?>catalog_mode<?php endif; ?>">
	...
	<div class="product_wrapper">
		...
		<div class="view-details"><a href="<?php the_permalink(); ?>" class="btn-new-black">VIEW DETAILS</a></div>
