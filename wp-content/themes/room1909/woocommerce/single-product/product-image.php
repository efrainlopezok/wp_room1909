...
$image       				= get_the_post_thumbnail( $post->ID, apply_filters( 'single_product_large_thumbnail_size', 'shop_single', array('class' => 'wp-post-image') ) );
                ...
                foreach ( $attachment_ids as $attachment_id ) {
					...
					<div class="<?php echo $zoom_class; ?>">
                        ...
                        <a data-fresco-group="product-gallery" data-fresco-options="fit: 'width'" class="<?php echo $modal_class; ?>" href="<?php echo esc_url($image_link); ?>">
                            ...
                            <img src="<?php echo esc_url($image_src[0]); ?>" data-src="<?php echo esc_url($image_data_src[0]); ?>" class="lazyOwl wp-post-image" alt="<?php echo esc_html($image_title); ?>">
                            <?php echo $plus_button; ?>
