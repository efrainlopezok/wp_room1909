...
<div class="row">
	<div class="large-10 text-center large-centered columns">
		...
		<p class="">Ops, looks like your cart is empty.</p>
		
		<p class="return-to-shop"><a class="wc-backward" href="<?php echo get_permalink( wc_get_page_id( 'shop' ) ); ?>"><?php _e( 'Return to the shop to get your suit on.', 'woocommerce' ) ?></a></p>
