<?php
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields' => array (
            ...
            array(
                'title' => __('Header Spacing (Top/Bottom)', 'mr_tailor_settings'),
                'id' => 'header_paddings',
                'type' => 'slider',
                "default" => 30,
                "min" => 0,
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'     => array(
            ...
            array (
                ...
                'on' => __('ON', 'mr_tailor_settings'),
                'off' => __('OFF', 'mr_tailor_settings'),
                'type' => 'switch',
                'default' => 1,
            ),
            
            array (
                'title' => __('Custom Wishlist Icon', 'mr_tailor_settings'),
            ...
            array (
                'title' => __('Custom Shopping Bag Icon', 'mr_tailor_settings'),
            ...
            array (
                'title' => __('Header Search', 'mr_tailor_settings'),
            ...
            array (
                'title' => __('Custom Search Icon', 'mr_tailor_settings'),
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'     => array(
            ...
            array (
                ...
                'subtitle' => __('Used on the <strong>Sticky Header</strong>', 'mr_tailor_settings'),
