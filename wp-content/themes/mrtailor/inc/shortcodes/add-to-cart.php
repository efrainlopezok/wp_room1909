...
function shortcode_custom_add_to_cart($atts, $content = null) {
    ...
    <p class="product woocommerce add_to_cart_inline" style="text-align:<?php echo $align; ?>">
		...
		echo apply_filters( 'woocommerce_loop_add_to_cart_link',
			sprintf( "<a style=\"color: $text_color; background-color: $bg_color !important;\" href=\"%s\" rel=\"nofollow\" data-product_id=\"%s\" data-product_sku=\"%s\" data-quantity=\"%s\" class=\"$class %s ajax_add_to_cart product_type_%s\"><span>%s</span></a>",
