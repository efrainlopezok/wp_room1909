<div class="wrap about-wrap getbowtied-about-wrap getbowtied-welcome-wrap">
	...
	<?php 
		...
		if ( !is_plugin_active('getbowtied-tools/getbowtied-tools.php') ): ?>
			<div class="inner">
				<img src="<?php echo get_template_directory_uri();?>/images/mr-tailor-thumb.png" alt="welcome" />
				<h1>Welcome to Mr. Tailor!</h1>
				...
				<?php 
					...
					echo $actions['button'];
				?>
				<br/><a href="http://mrtailor.wp-theme.help/hc/en-us/articles/206694609-Getting-Started"  target="_blank" class="video-guide"><span class="dashicons dashicons-video-alt3"></span> <?php echo __("Installation & Setup <span class='dashicons dashicons-minus'></span> Video Guide"); ?></a>
